package com.zwiki.memory.controller;
...
import com.zwiki.memory.service.CodeReviewMemoryService;
...
public class MemoryController {
    ...
    public ResponseEntity<String> updateMemory(@PathVariable("memoryId") String memoryId, 
        ...
        try {
            logger.info("更新记忆: memoryId={}, requestMemoryId={}", memoryId, request.getMemoryId());
            
            Map<String, Object> updateData = Map.of("memory", request.getMemory());
            memZeroServiceClient.updateMemory(memoryId, updateData);
            ...
            logger.error("更新记忆失败: memoryId={}, requestMemoryId={}", memoryId, request.getMemoryId(), e);
