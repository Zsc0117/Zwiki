...
public class DocumentMemoryService {
    ...
    public CompletableFuture<Void> addDocumentMemoryAsync(String repositoryId, 
        ...
        return addDocumentMemoryAsync(repositoryId, repositoryId, documentName, documentContent, documentUrl, metadata);
    }
    ...
    public CompletableFuture<Void> addDocumentMemoryAsync(String repositoryId,
        ...
        return CompletableFuture.runAsync(() -> {
            ...
            try {
                tenantUserId = (userId != null && !userId.isBlank()) ? userId : repositoryId;
                logger.info("开始添加文档记忆: repositoryId={}, userId={}, documentName={}", repositoryId, tenantUserId, documentName);
                ...
                logger.info("成功添加文档记忆: repositoryId={}, userId={}, documentName={}", repositoryId, tenantUserId, documentName);
                
            } catch (Exception e) {
                logger.error("添加文档记忆失败: repositoryId={}, userId={}, documentName={}", repositoryId, tenantUserId, documentName, e);
    ...
    public CompletableFuture<Void> addCodeFileMemoryAsync(String repositoryId,
                                                         ...
                                                         String fileContent,
                                                         String fileType) {
        return addCodeFileMemoryAsync(repositoryId, repositoryId, fileName, filePath, fileContent, fileType);
    }
    ...
    public CompletableFuture<Void> addCodeFileMemoryAsync(String repositoryId,
        ...
        return CompletableFuture.runAsync(() -> {
            ...
            try {
                tenantUserId = (userId != null && !userId.isBlank()) ? userId : repositoryId;
                logger.info("开始添加代码文件记忆: repositoryId={}, userId={}, fileName={}", repositoryId, tenantUserId, fileName);
                ...
                logger.info("成功添加代码文件记忆: repositoryId={}, userId={}, fileName={}", repositoryId, tenantUserId, fileName);
                
            } catch (Exception e) {
                logger.error("添加代码文件记忆失败: repositoryId={}, userId={}, fileName={}", repositoryId, tenantUserId, fileName, e);
